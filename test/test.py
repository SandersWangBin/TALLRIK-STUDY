...
('#0021', '(<a>*[1:3]; (<b>*[0:2]|<c>*[1:2])*[1:2]|<d>*[0:1], <e>; <f>*[1:2])*[0:2] | <g>', '<a> <c> <b> <b> <e> <f> <a> <b> <c> <c> <e> <f>', [['<a>', '<b>', '<c>', '<d>', '<e>'], ['<c>', '<e>'], ['<b>', '<e>'], ['<e>'], ['<f>'], ['<f>'], ['<a>', '<b>', '<c>', '<d>', '<e>'], ['<b>', '<e>'], ['<c>', '<e>'], ['<e>'], ['<f>'], ['<f>']]), \
...
#print fireNodes('(<a>*[1:3]; (<b>*[0:2]|<c>*[1:2])*[1:2]|<d>*[0:1], <e>; <f>*[1:2])*[0:2] | <g>', '<a> <c> <b> <b> <e> <f> <a> <b> <c> <c> <e> <f>', [['<a>', '<b>', '<c>', '<d>', '<e>'], ['<c>', '<e>'], ['<b>', '<e>'], ['<e>'], ['<f>'], ['<f>'], ['<a>', '<b>', '<c>', '<d>', '<e>'], ['<b>', '<e>'], ['<c>', '<e>'], ['<e>'], ['<f>'], ['<f>']], True)
